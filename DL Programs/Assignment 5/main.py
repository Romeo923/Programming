...
def main():
    ...
    #NN.Train(50,0.1,0.0,20,LROptimizerType.NONE, doBatchNorm) # with BatchNorm = True, try with and without ADAM
    NN.Train(30,0.1,0.0,20,LROptimizationType.ADAM, doBatchNorm) # with doBatchNorm = False, 90%
