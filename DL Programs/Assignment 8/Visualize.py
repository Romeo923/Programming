...
def main():
    ...
    model = torch.load('DL Programs/Assignment 8/checkpoint/finalsiamese.tar')
    ...
    for label in labelset:
        ...
        ax.legend()
        fig.savefig('DL Programs/Assignment 8/embed.jpeg', format='jpeg', dpi=600, bbox_inches='tight')
    plt.plot()
    plt.draw()
