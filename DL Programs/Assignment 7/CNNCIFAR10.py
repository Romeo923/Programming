...
def main():
    ...
    print(device)
    path_data = './DL Programs/data/' # for storing the dataset
    batch_size = 16
    num_epochs = 100

    trainds, trainloader, testds, testloader = Utils.prepare_data(path_data, batch_size)
    train_iter = iter(trainloader)
    images, labels = next(train_iter) # getk a batch of data e.g., 16x3x32x32
    ...
    fname = './DL Programs/models/CIFAR10_cnn.pth'
