...
\begin{center}
  ...
  \draw[line width=2pt,red,-stealth](0,0,0)--(1,3,-2) node[anchor=south west]{${\langle 1,3,-2 \rangle}$};
  \draw[line width=2pt,red,-stealth](0,0,0)--(0,0,6) node[anchor=south west]{${\langle 0,0,6 \rangle}$};
  \draw[line width=2pt,blue,-stealth](0,0,0)--(1,3,4) node[anchor=south west]{Sum: ${\langle 1,3,4 \rangle}$};
\end{tikzpicture}
\end{center}
