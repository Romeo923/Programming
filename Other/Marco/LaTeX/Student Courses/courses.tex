    ...
    \begin{Form}
        ...
        \begin{table}[h!]
            \begin{tabular}{|c|c|c|c|c|c|} \hline
                ...
                \mbox{\CheckBox[name=box1f]{}} & \mbox{\TextField[name=course1f]{}} & \mbox{\TextField[width=1cm,name=credits1f,value=2]{}} & \mbox{\CheckBox[name=box1s]{}} & \mbox{\TextField[name=course1s]{}} & \mbox{\TextField[width=1cm,name=credits1s]{}} \\ \hline
                ...
                \multicolumn{2}{|c|}{Total Credits: } & \TextField[name=totalCreditsf,width=1cm,readonly=true}]{} & \multicolumn{2}{|c|}{Total Credits: } & \py{2+5**2} \\ \hline
            \end{tabular}
        \end{table}
    \end{Form}
\end{document}